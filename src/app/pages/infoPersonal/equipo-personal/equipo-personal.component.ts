...
@Component({
  selector: 'app-equipo-personal',
  templateUrl: './equipo-personal.component.html',
  styleUrls: ['./equipo-personal.component.css']
})
export class EquipoPersonalComponent implements OnInit {
  public dias: DiaInfo[]
