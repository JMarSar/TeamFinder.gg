...
export class UsuarioPersonalComponent implements OnInit {

  public dias: DiaInfo[]
  public torneosTotal: Conexiones[];
  public fechaHoy: Date;
  public mostrarTorneos: boolean;
  public estadistica: Estadistica;
  public porcenGanados: number;
  public admin: boolean;
  public userEquipo:boolean;
  public rankingP: Ranking[];
  //Este es para cambiar en un futuro.
  public equipoNecesita: boolean;
  //
  ...
  constructor() { 
    ...
    this.admin = true;
    this.userEquipo = true;
    //Este es para cambiar en un futuro.
    this.equipoNecesita = true;
    //Tambien hay que introducir un booleano para si el equip busca jugadores y otro para si esta lleno;
    this.rankingP = [
      new Ranking(false,'Guillermo',1),
      new Ranking(false,'Jaime',2),
      new Ranking(true,'JohnDoe',3),
      new Ranking(false,'Pepe',4),
      new Ranking(false,'Rosalinda',5),
    ]
  }
